<template>
  <div>
    <div class="card mb10">
      ...
      <span class="text">
        <el-link type="primary" href="https://docs.spicyboy.cn" target="_blank">HTTP接口管理平台</el-link>
        一款基于 Vue3.3、TypeScript、Vite4、Pinia、Element-Plus 开源的后台管理系统，使用目前最新技术栈开发。
      </span>
    </div>
    <div class="card mb10">
